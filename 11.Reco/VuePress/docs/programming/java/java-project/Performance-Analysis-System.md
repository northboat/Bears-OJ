...
> 一款基于bootstrap、thymeleaf、springboot的成绩管理系统

[Performance Analysis System](http://39.106.160.174:8080/)

想要账号请联系 1543625674@qq.com

功能：登录注销，班级成绩基础信息展示，分科目的成绩排名展示，CRUD单个学生信息，分科目的排名文件生成，界面非常美观实用

缺陷：前后端未分离，后端压力较大；数据储存有局限，没有班级、学校作为外键
