...
class Main{
	...
	public static void main(String[] args){
		...
		for(i = 0; i < data.length; i++){
			...
			//the statement should be writen own
			int[] curAns = solution.sortNums(srcNum);
			for(int j = 0; j < curAns.length; j++){
				if(curAns[j] != realAns[j]){
